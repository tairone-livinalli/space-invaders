(() => {
  ...
  __name(Ve, "Ve");
  a(Ve, "lerp");
  function dt2(i2, t, l, w, U) {
    return w + (i2 - t) / (l - t) * (U - w);
  }
  __name(dt2, "dt");
  a(dt2, "map");
  function dr(i2, t, l, w, U) {
    return z(dt2(i2, t, l, w, U), w, U);
  }
  __name(dr, "dr");
  a(dr, "mapc");
...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  var INVADER_SPEED_RIGHT = 100;
  var INVADER_SPEED_LEFT = -100;
  var BULLET_SPEED = 400;
  var INVADER_CURRENT_SPEED = INVADER_SPEED_RIGHT;
  var STARTER_TIME_LEFT = 100;
  var LEVEL_DOWN = 200;
  ...
  var generateWalls = /* @__PURE__ */ __name(() => {
